...
dispatch された Agent の一生は, 起動から後始末までの一巡で回る.

<svg viewBox="0 0 720 360" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="dispatch から teardown までの一巡" font-family="sans-serif" font-size="13">
  <defs>
    <marker id="cah" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto">
      <path d="M0,0 L7,3 L0,6 Z" fill="#555"/>
    </marker>
    <marker id="cahd" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto">
      <path d="M0,0 L7,3 L0,6 Z" fill="#b58a4a"/>
    </marker>
  </defs>
  <!-- coordinator -->
  <rect x="260" y="20" width="200" height="64" rx="6" fill="#fbf7ee" stroke="#b58a4a"/>
  <text x="360" y="46" text-anchor="middle" font-weight="bold">対話 coordinator</text>
  <text x="360" y="66" text-anchor="middle" fill="#555" font-size="11">dispatch / 集約 / 操舵</text>
  <!-- feed -->
  <rect x="30" y="180" width="190" height="64" rx="6" fill="#fff" stroke="#999"/>
  <text x="125" y="206" text-anchor="middle">feed (下り channel)</text>
  <text x="125" y="226" text-anchor="middle" fill="#888" font-size="11">task-id / brief / allowed_paths</text>
  <!-- repo agent -->
  <rect x="265" y="180" width="190" height="64" rx="6" fill="#eef4fb" stroke="#4a78b5"/>
  <text x="360" y="206" text-anchor="middle" font-weight="bold">repo agent (cmux tab)</text>
  <text x="360" y="226" text-anchor="middle" fill="#555" font-size="11">worktree で実作業</text>
  <!-- inbox -->
  <rect x="500" y="180" width="190" height="64" rx="6" fill="#fff" stroke="#999"/>
  <text x="595" y="206" text-anchor="middle">inbox (上り channel)</text>
  <text x="595" y="226" text-anchor="middle" fill="#888" font-size="11">task-id + done</text>
  <!-- (1) coordinator -> feed -->
  <path d="M300,84 L150,180" stroke="#555" fill="none" marker-end="url(#cah)"/>
  <text x="186" y="126" text-anchor="middle" fill="#333" font-size="11">(1) 指示を書く</text>
  <!-- (2) feed -> agent -->
  <line x1="220" y1="212" x2="265" y2="212" stroke="#555" marker-end="url(#cah)"/>
  <text x="242" y="174" text-anchor="middle" fill="#333" font-size="11">(2) pull_inbox</text>
  <!-- 起動 launch -->
  <line x1="378" y1="84" x2="378" y2="180" stroke="#555" marker-end="url(#cah)"/>
  <text x="386" y="126" fill="#333" font-size="11">起動</text>
  <text x="386" y="141" fill="#888" font-size="10">cmux new-workspace</text>
  <!-- teardown -->
  <line x1="344" y1="84" x2="344" y2="180" stroke="#b58a4a" stroke-dasharray="4 3" marker-end="url(#cahd)"/>
  <text x="336" y="126" text-anchor="end" fill="#b58a4a" font-size="11">(5) teardown</text>
  <text x="336" y="141" text-anchor="end" fill="#b58a4a" font-size="10">cmux close</text>
  <!-- (3) agent -> inbox -->
  <line x1="455" y1="212" x2="500" y2="212" stroke="#555" marker-end="url(#cah)"/>
  <text x="478" y="174" text-anchor="middle" fill="#333" font-size="11">(3) 報告</text>
  <!-- (4) inbox -> coordinator -->
  <path d="M595,180 L430,84" stroke="#555" fill="none" marker-end="url(#cah)"/>
  <text x="540" y="126" text-anchor="middle" fill="#333" font-size="11">(4) done を検知</text>
</svg>
...
<svg viewBox="0 0 640 540" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="仲介承認の判定フロー" font-family="sans-serif" font-size="13">
  <defs>
    <marker id="dah" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto">
      <path d="M0,0 L7,3 L0,6 Z" fill="#555"/>
    </marker>
  </defs>
  <!-- tool call -->
  <rect x="220" y="20" width="200" height="50" rx="6" fill="#eef4fb" stroke="#4a78b5"/>
  <text x="320" y="50" text-anchor="middle" font-weight="bold">repo agent の tool 呼び出し</text>
  <line x1="320" y1="70" x2="320" y2="100" stroke="#555" marker-end="url(#dah)"/>
  <!-- decision 1: heartbeat -->
  <rect x="208" y="100" width="224" height="58" rx="6" fill="#fbf7ee" stroke="#b58a4a"/>
  <text x="320" y="125" text-anchor="middle" font-weight="bold">coordinator heartbeat 新鮮?</text>
  <text x="320" y="144" text-anchor="middle" fill="#555" font-size="11">per-repo, TTL 180s</text>
  <!-- branch no -> native -->
  <line x1="432" y1="129" x2="488" y2="129" stroke="#555" marker-end="url(#dah)"/>
  <text x="460" y="120" text-anchor="middle" fill="#333" font-size="11">いいえ</text>
  <rect x="488" y="101" width="142" height="58" rx="6" fill="#eef7ee" stroke="#5a9a5a"/>
  <text x="559" y="125" text-anchor="middle" font-size="12">solo session</text>
  <text x="559" y="143" text-anchor="middle" fill="#555" font-size="11">native (素通り)</text>
  <!-- down はい -->
  <line x1="320" y1="158" x2="320" y2="190" stroke="#555" marker-end="url(#dah)"/>
  <text x="332" y="178" fill="#333" font-size="11">はい</text>
  <!-- decision 2: mutating -->
  <rect x="208" y="190" width="224" height="58" rx="6" fill="#fbf7ee" stroke="#b58a4a"/>
  <text x="320" y="215" text-anchor="middle" font-weight="bold">変更系 + MCP tool?</text>
  <text x="320" y="234" text-anchor="middle" fill="#555" font-size="11">Edit / Write / Bash / mcp__*</text>
  <!-- branch no -> passthrough -->
  <line x1="432" y1="219" x2="488" y2="219" stroke="#555" marker-end="url(#dah)"/>
  <text x="460" y="210" text-anchor="middle" fill="#333" font-size="11">いいえ</text>
  <rect x="488" y="191" width="142" height="58" rx="6" fill="#eef7ee" stroke="#5a9a5a"/>
  <text x="559" y="215" text-anchor="middle" font-size="12">read-only</text>
  <text x="559" y="233" text-anchor="middle" fill="#555" font-size="11">素通り</text>
  <!-- down はい -->
  <line x1="320" y1="248" x2="320" y2="280" stroke="#555" marker-end="url(#dah)"/>
  <text x="332" y="268" fill="#333" font-size="11">はい</text>
  <!-- escalate -->
  <rect x="208" y="280" width="224" height="58" rx="6" fill="#f6f1fb" stroke="#7a5aa5"/>
  <text x="320" y="305" text-anchor="middle" font-weight="bold">coordinator に escalate</text>
  <text x="320" y="323" text-anchor="middle" fill="#555" font-size="11">full payload + path 検証</text>
  <line x1="320" y1="338" x2="320" y2="370" stroke="#555" marker-end="url(#dah)"/>
  <!-- user -->
  <rect x="208" y="370" width="224" height="58" rx="6" fill="#fff" stroke="#999"/>
  <text x="320" y="395" text-anchor="middle" font-weight="bold">user が承認</text>
  <text x="320" y="413" text-anchor="middle" fill="#555" font-size="11">AskUserQuestion</text>
  <!-- approve -->
  <line x1="268" y1="428" x2="180" y2="462" stroke="#555" marker-end="url(#dah)"/>
  <text x="200" y="450" text-anchor="end" fill="#333" font-size="11">承認</text>
  <rect x="40" y="462" width="220" height="58" rx="6" fill="#eef7ee" stroke="#5a9a5a"/>
  <text x="150" y="487" text-anchor="middle" font-weight="bold">無プロンプトで実行</text>
  <text x="150" y="505" text-anchor="middle" fill="#555" font-size="11">hook allow</text>
  <!-- reject -->
  <line x1="372" y1="428" x2="460" y2="462" stroke="#555" marker-end="url(#dah)"/>
  <text x="440" y="450" fill="#333" font-size="11">却下</text>
  <rect x="380" y="462" width="220" height="58" rx="6" fill="#f7eeee" stroke="#a55a5a"/>
  <text x="490" y="487" text-anchor="middle" font-weight="bold">deny</text>
