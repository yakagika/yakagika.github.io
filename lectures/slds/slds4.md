...
![memory null](/images/slds/ch4/memory-null.png)
...
![memory 10](/images/slds/ch4/memory-10.png)
...
![memory 10](/images/slds/ch4/memory-10y.png)
...
![memory 15](/images/slds/ch4/memory-15.png)
...
print((x + y) % 2 != 0)   # True  (x + y = 303 は奇数)
~~~
...
~~~ python
# letsstart.py
print("Let's start Python programming!!")
~~~
...
![エラー文の読み方](/images/slds/ch4/python-error-sample1.png)

![](/images/slds/ch4/translate-error.png)
