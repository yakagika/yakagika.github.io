...
![データ分析の流れ](/images/slds/ch2/data-science-flow.png)
...
![情報の抽出](/images/slds/ch2/info-to-model.png)
...
過去の研究事例は[こちら](/slds_papers.html)から閲覧できます.(各エントリを展開するとブラウザ内でPDFを閲覧でき, ダウンロードも可能です.)
...
![目的,手法,データ](/images/slds/ch2/purpose-method-data.png)
