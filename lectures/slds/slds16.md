...
![](/images/slds/ch16/rosenberg.png)
...
![](/images/slds/ch16/sushi.png)

![](/images/slds/ch16/carpaccio.png)
...
![上位・下位の構造,並列構造,類型的構造の例](/images/slds/ch16/image-structure.png)
...
データは[こちら](https://github.com/yakagika/yakagika.github.io/blob/main/slds_data/ch16/questionnaire_sample_original.csv)からダウンロードできます.
...
![データの形式](/images/slds/ch16/data-sample.png)

分析の際には,これらの情報を利用しやすいように変形する必要があります. ここでは,練習も兼ねて一通りの処理を体験してみましょう.

本節の加工手順は本文のコードで再現できます. 内容を確認して自力でできると感じた方はこの節を飛ばしていただいて構いません.
...
![アンケートデータヒストグラム](/images/slds/ch16/q13-17-histgram.png)
...
![スピアマンの順位相関係数](/images/slds/ch16/spearman.png)
...
![同時度数分布表](/images/slds/ch16/cross.png)
...
![標準化残渣](/images/slds/ch16/regit.png)
...
![次元削減の結果確認](/images/slds/ch16/pca-graph.png)


![合成変数の相関係数](/images/slds/ch16/pca-corr.png)
...
![](/images/slds/ch16/sem-5.png)

また,パス図として結果を表示してくれる機能もあります.

![](/images/slds/ch16/sem6.png)
