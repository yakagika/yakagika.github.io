...
本講義の章立ては以下のようになっています
(クリックすることで各章に飛べます.)

[第1章 イントロダクション](fp1.html)

[第2章 環境構築](fp2.html)

[第3章 Haskellを使ってみよう](fp3.html)

[第4章 スクリプトファイルとエラー対応](fp4.html)

[第5章 関数](fp5.html)

[第6章 関数(応用編)](fp6.html)

[第7章 代数的データ型と関係](fp7.html)

[第8章 型クラスと代数構造](fp8.html)

[第9章 圏と多相データ型](fp9.html)

[第10章 モナドと入出力](fp10.html)

[第11章 可変状態と効果](fp11.html)

[第12章 総合演習](fp12.html)

[補足A 計算量とデータ構造の性能](fp_a1.html)

現在執筆中のため,章の構成等は変更される可能性があります.

<!--
TODO: 上記の章マップに各章の到達目標・学習の流れ(環境構築 → 基本構文 → データ型 → 代数的設計)を追記し,学習ロードマップ化する(資料全体が完成してから).
-->
...
関数型言語でプログラミングをするとは,**｢それが何か｣**を分解して書いていくことです.
